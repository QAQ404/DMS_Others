...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='宿舍楼';

-- ----------------------------
-- Records of building
-- ----------------------------
INSERT INTO `building` VALUES ('1', '1栋', '2', '2', '0', '0');
INSERT INTO `building` VALUES ('2', '2栋', '1', '1', '0', '0');
INSERT INTO `building` VALUES ('3', '3栋', '1', '2', '0', '0');
INSERT INTO `building` VALUES ('4', '4栋', '1', '2', '0', '0');
INSERT INTO `building` VALUES ('5', '5栋', '1', '2', '0', '0');
INSERT INTO `building` VALUES ('6', '6栋', '1', '2', '0', '0');
INSERT INTO `building` VALUES ('7', '7栋', '1', '1', '0', '0');
...
-- ----------------------------
INSERT INTO `building_info` VALUES ('1', '2010-09-02', '1栋是个好宿舍', 'https://hzh-biyesheji.oss-cn-beijing.aliyuncs.com/9d88300e-2e61-4682-9f11-951bfd225618.jpg', '2024-01-21 22:24:03', '2');
INSERT INTO `building_info` VALUES ('2', null, null, null, '2024-01-21 08:44:28', '1');
INSERT INTO `building_info` VALUES ('3', null, null, null, '2024-01-21 08:44:28', '1');
INSERT INTO `building_info` VALUES ('4', null, null, null, '2024-01-21 08:44:28', '1');
...
INSERT INTO `building_info` VALUES ('7', null, null, null, '2024-01-21 08:44:28', '1');
...
-- Records of manager
-- ----------------------------
INSERT INTO `manager` VALUES ('1', '男', null, null, null, '9', '20240001');
INSERT INTO `manager` VALUES ('2', '男', null, null, null, '0', '20240002');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_get_all_building_manager` AS select `building`.`id` AS `id`,`building`.`name` AS `name`,`building`.`unit_number` AS `unit_number`,`building`.`dor_number` AS `dor_number`,`building`.`stu_number` AS `stu_number`,`user`.`name` AS `man_name` from (`building` join `user`) where (`user`.`id` = `building`.`manager_id`) ;
