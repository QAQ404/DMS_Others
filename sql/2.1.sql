...
INSERT INTO `dormitory` VALUES ('2', '1', '101', '1', '0', '4', '2024-01-30 10:36:29', '1', 'https://hzh-biyesheji.oss-cn-beijing.aliyuncs.com/4197b720-6085-4389-87d7-cf284430aa7f.jpg');
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='学院';

-- ----------------------------
-- Records of institute
-- ----------------------------
INSERT INTO `institute` VALUES ('1', '软件学院', '3', '0', '0');
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='专业';

-- ----------------------------
-- Records of major
-- ----------------------------
INSERT INTO `major` VALUES ('1', '软件工程', '0', '1', '0');
INSERT INTO `major` VALUES ('3', '国际英语2', '0', '4', '0');
