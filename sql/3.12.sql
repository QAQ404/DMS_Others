...
-- Records of building
-- ----------------------------
INSERT INTO `building` VALUES ('1', '1栋', '2', '2', '16', '3');
...
INSERT INTO `building` VALUES ('14', '临时宿舍楼', '1', '999', '1', '5');
...
CREATE TABLE `change_dormitory_application` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='申请换寝表';

-- ----------------------------
-- Records of change_dormitory_application
-- ----------------------------
INSERT INTO `change_dormitory_application` VALUES ('21', '8', '2', '7', '-1', null, null, '2', '2024-02-28 21:37:08', '2024-02-28 23:35:46');
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='班级';
...
INSERT INTO `clazz` VALUES ('5', '2', '2', '1', '2020');
...
INSERT INTO `clazz` VALUES ('11', '1', '0', '3', '2020');
...
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='学生寝室';

-- ----------------------------
-- Records of dormitory
-- ----------------------------
INSERT INTO `dormitory` VALUES ('1', '14', '暂未分配寝室', '1', '5', '99999', '2024-02-14 10:07:11', '1', null);
...
INSERT INTO `dormitory` VALUES ('7', '1', '102', '1', '2', '4', '2024-02-28 19:59:46', '1', null);
...
INSERT INTO `dormitory` VALUES ('16', '1', '201', '1', '0', '4', '2024-02-23 12:05:55', '2', null);
...
INSERT INTO `dormitory` VALUES ('22', '1', '206', '1', '0', '4', '2024-02-19 21:14:03', '2', null);
...
-- ----------------------------
INSERT INTO `institute` VALUES ('1', '软件学院', '3', '6', '8');
INSERT INTO `institute` VALUES ('3', '土木学院', '0', '0', '0');
INSERT INTO `institute` VALUES ('4', '国际学院', '1', '1', '0');
...
-- Records of major
-- ----------------------------
INSERT INTO `major` VALUES ('1', '软件工程', '6', '1', '8');
INSERT INTO `major` VALUES ('3', '国际英语', '1', '4', '0');
...
-- Records of manager
-- ----------------------------
INSERT INTO `manager` VALUES ('7', '男', null, 'https://hzh-biyesheji.oss-cn-beijing.aliyuncs.com/abcf4591-b92b-4dd2-978a-87145059a5c3.jpg', null, '1', '       7');
...
CREATE TABLE `repair_application` (
  ...
  `state` int DEFAULT NULL COMMENT '申请的状态，2已处理，1是已拒绝，0是未处理，-1是已失效',
  ...
  `create_time` datetime DEFAULT NULL COMMENT '申请时间',
  `update_time` datetime DEFAULT NULL COMMENT '处理时间',
  `manger_id` int DEFAULT NULL COMMENT '处理的宿管Id',
  `manager_message` text COMMENT '处理者留言',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='寝室保修申请表';

-- ----------------------------
-- Records of repair_application
-- ----------------------------
INSERT INTO `repair_application` VALUES ('1', '8', '7', '0', null, '电灯', '电灯坏了', '2024-03-02 10:54:11', null, null, null);
INSERT INTO `repair_application` VALUES ('2', '8', '7', '0', null, '插座', '插座坏了', '2024-03-12 10:28:50', null, null, null);
...
-- Records of student
-- ----------------------------
INSERT INTO `student` VALUES ('8', '7', '202001010101', '男', '1', '1', '1', '2020');
INSERT INTO `student` VALUES ('11', '2', '202001010102', '男', '1', '1', '1', '2020');
INSERT INTO `student` VALUES ('15', '7', '202001010103', '男', '1', '1', '1', '2020');
INSERT INTO `student` VALUES ('12', '1', '202001010104', '女', '1', '1', '1', '2020');
INSERT INTO `student` VALUES ('13', '1', '202001010105', '男', '1', '1', '1', '2020');
INSERT INTO `student` VALUES ('14', '1', '202001010106', '男', '1', '1', '1', '2020');
INSERT INTO `student` VALUES ('17', '1', '202001010201', '男', '1', '5', '1', '2020');
INSERT INTO `student` VALUES ('18', '1', '202001010202', '男', '1', '5', '1', '2020');
...
CREATE TABLE `student_info` (
  ...
  `home` varchar(64) DEFAULT NULL COMMENT '家庭住址',
  `political_face` varchar(20) DEFAULT NULL COMMENT '政治面貌',
...
-- ----------------------------
INSERT INTO `student_info` VALUES ('8', '13513543322', 'https://hzh-biyesheji.oss-cn-beijing.aliyuncs.com/e09be688-cb00-45fc-a6c4-f88f068f1767.jpg', '18299336278@qq.com', '我是好学生', '2024-02-24 20:29:03', '汉族', '2002-02-12', null, null);
INSERT INTO `student_info` VALUES ('11', null, null, null, null, '2024-02-20 11:16:37', null, null, null, null);
INSERT INTO `student_info` VALUES ('12', null, null, null, null, '2024-02-20 11:16:47', null, null, null, null);
INSERT INTO `student_info` VALUES ('13', null, null, null, null, '2024-02-20 11:16:55', null, null, null, null);
INSERT INTO `student_info` VALUES ('14', null, null, null, null, '2024-02-21 20:28:01', null, null, null, null);
INSERT INTO `student_info` VALUES ('15', null, null, null, null, '2024-02-20 11:34:53', null, null, null, null);
INSERT INTO `student_info` VALUES ('17', null, null, null, null, '2024-02-21 15:21:58', null, null, null, null);
INSERT INTO `student_info` VALUES ('18', null, null, null, null, '2024-02-24 11:50:04', null, null, null, null);
...
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='账号管理';
