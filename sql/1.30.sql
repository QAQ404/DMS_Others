...
-- ----------------------------
INSERT INTO `institute` VALUES ('1', '软件学院', '0', '0', '0');
INSERT INTO `institute` VALUES ('3', '土木学院', '0', '0', '0');
INSERT INTO `institute` VALUES ('4', '国际学院', '0', '0', '0');
...
CREATE TABLE `major` (
  ...
  `stu_number` int DEFAULT NULL COMMENT '学生数',
  PRIMARY KEY (`id`),
  KEY `major_institute_id_fk` (`ins_id`),
  CONSTRAINT `major_institute_id_fk` FOREIGN KEY (`ins_id`) REFERENCES `institute` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='专业';
